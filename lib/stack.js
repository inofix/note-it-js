...
class Stack {
  constructor(
    ...
    new Adhesive(board, group, null, 'stack1', color, geometry, [
      position[0] + 4,
      position[1] + 4
    ])
    new Adhesive(board, group, null, 'stack0', color, geometry, [
      position[0] + 2,
      position[1] + 2
    ])
    let n = new NoteIt(board, group, null, 'stack', color, geometry, [
      position[0],
      position[1]
    ])
    n.addType('Type')

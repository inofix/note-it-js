...
//        let l = this.geometry[0] / 2 + 1;
    ...
    toJSON() {
        ...
        if (typeof this.parent_object === 'object') {
            ...
            json += '"parentId": ' + this.parent_object.id + ', ';
        }
...
//        nt.on("drag", null);
        rt.on("mouseover", function() { n.open_textinput(n.content, [6,"2em"], [l + "em", h + "em"])});
        nt.on("mouseover", function() { n.open_textinput(n.content, [6,"2em"], [l + "em", h + "em"])});
    }
    ...
    open_textinput(textelement, position, geometry) {
        ...
        var foreign = textelement.append("foreignObject")
                ...
                .attr("width", geometry[0]).attr("height", geometry[1]);
...
//TODO: I'd prefer "focus/blur" here. Collision with "drag"?
    ...
    toJSON() {
        ...
        if (typeof this.content !== 'undefined' &&
                typeof this.content.node().textContent === 'string') {
            json += '"content": "' + this.content.node().textContent + '" }';
        }
        return json;
    }
}

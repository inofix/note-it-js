...
class SketchBoard {
    ...
    constructor(svg_selector, geometry=[], uuid, dark=false) {
        ...
        this.group = this.svg.append("g").attr("class", "mamma");
        return this;
    }
...
class Adhesive {
    ...
    add_handle_new() {
        ...
        h.on("click", function() {
            new Adhesive(b, g, c, ge, [nX, nY], ha, true);
        });
    }
...
class NoteIt extends Adhesive {
    ...
    add_handle_new() {
        ...
        h.on("click", function() {
            var n = new NoteIt(b, g, c, ge, [nX,nY]);
...
var rstack = new Stack(board, board.group, "Type", ["#f7ff72", "#ff6ee2", "#6ee0ff"], [16,16]);

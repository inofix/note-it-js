...
// it is probably time for a class Handle()
    ...
    addHandleURL() {
        ...
        let h = this.addHandle(4.8, "U");
    }

    addHandlePhoto() {

        let h = this.addHandle(4, "P");
    }

    addHandleLabel() {

        let h = this.addHandle(3.2, "L");

    ...
    **/
    drawEdge(adhesive) {
        if (this.edgeVisible) {
            ...
            if (this.board.shadow) {
                if (this.parentEdgeShadow !== null) {
                    this.parentEdgeShadow.remove();
                }
                this.parentEdgeShadow = this.group.append("line")
                        .attr("x1", p1[0]+1)
                        .attr("x2", p2[0]+1)
                        .attr("y1", p1[1]+2)
                        .attr("y2", p2[1]+2)
...
//TODO: use style of original text element (via CSS)..
    ...
    static create(board, key) {
        ...
        if (typeof o === 'object') {
            ...
            let a = new URI(board, group, p, key, o["color"],
                                    o["geometry"], o["position"]);
            a.setFeatures(o["handles"], o["draggable"], o["persistable"],
                                o["edgeVisible"], o["uri"]);
            if (typeof o["parentId"] !== 'undefined') {

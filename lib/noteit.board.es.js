...
class SketchBoard {
    ...
    createAdhesive(adhesiveKey) {
        var o = this.adhesiveQueue.get(adhesiveKey);
        switch (o["class"]) {
            case "adhesive":
...
// board, group handles, draggable
    ...
    static create(board, key) {
        ...
        if (board.adhesives.has(key)) {
            return board.adhesives.get(key);
        } else {
            ...
            let a = new Adhesive(board, group, o["color"],
...
//        nt.on("drag", null);
    ...
    static create(board, key) {
        ...
        if (board.adhesives.has(key)) {
            ...
            let a = new NoteIt(board, group, o["color"],
                                    o["geometry"], o["position"]);
            a.set_features(o["handles"], o["draggable"], o["type"],
                                    o["title"], o["content"]);
            return a;

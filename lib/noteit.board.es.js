...
class Adhesive {
    ...
    constructor(group, color="#f7ff72", geometry=[10,10], position=[0,0], handles=[], draggable=true) {
...
class NoteIt extends Adhesive {
    ...
    constructor(group, type="Type", color="#f7ff72", geometry=[10,10], position=[2,2], handles=["close", "new"], draggable=true) {
        super(group, color, geometry, position, handles, draggable);
        this.type = type;
        this.add_type(type);
        this.add_title();
        this.add_content();
    ...
    add_handle_new() {
        ...
        h.on("click", function() {
            new NoteIt(g, t, c, ge, [nX,nY], undefined, true);
        });
    }
...
class Stack {
    ...
    constructor(group, type="Type", color="#f7ff72", geometry=[10,10], position=[2,2]) {
        ...
        new Adhesive(group, color, geometry, [ position[0] + 4, position[1] + 4], undefined, false);
        new Adhesive(group, color, geometry, [ position[0] + 2, position[1] + 2], undefined, false);
        let n = new NoteIt(group, type, color, geometry, [position[0], position[1]], ["new"], false);
    }
}
